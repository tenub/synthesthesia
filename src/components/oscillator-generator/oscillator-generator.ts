...
import { GeneratorNode, ToneEvent } from './oscillator-generator.interface';

@customElement('oscillator-generator')
export class OscillatorGenerator extends LitElement {
  @state()
  ...
  override render() {
    return html`
      <div class="oscillator-generator">
...
declare global {
  interface HTMLElementTagNameMap {
    'oscillator-generator': OscillatorGenerator;
  }
}
